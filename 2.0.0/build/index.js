...
kg/albums/2.0.0/dialog
kg/albums/2.0.0/rotate
kg/albums/2.0.0/theme/default-tpl
kg/albums/2.0.0/plugin/thumb
kg/albums/2.0.0/theme/default
kg/albums/2.0.0/index

*/
KISSY.add('kg/albums/2.0.0/dialog',function(S, Overlay, DD){
...
KISSY.add('kg/albums/2.0.0/rotate',function(S){
 ...
 */
KISSY.add('kg/albums/2.0.0/theme/default-tpl',function(){
...
KISSY.add('kg/albums/2.0.0/plugin/thumb',function(S, $, Base){
...
KISSY.add('kg/albums/2.0.0/theme/default',function(S, Node, Base,E, TPL, XTemplate, Thumb){
 ...
 * @module albums
 **/
KISSY.add('kg/albums/2.0.0/index',function (S, Node, Base, Overlay, Anim, dialog, rotate) {
  ...
  S.extend(Albums, Base, /** @lends Albums.prototype*/{
    ...
    theme: { value: 'kg/albums/2.0.0/theme/default' }
